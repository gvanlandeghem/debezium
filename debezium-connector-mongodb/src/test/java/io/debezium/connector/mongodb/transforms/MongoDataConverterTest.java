...
public class MongoDataConverterTest {
    ...
    public void shouldCreateCorrectStructFromInsertJson() {
        ...
        assertThat(struct.toString()).isEqualTo(
                ...
                + "cuisine=Bakery,"
                + "grades=["
                  + "Struct{date=Mon Mar 03 01:00:00 CET 2014,grade=A,score=2}, "
                  + "Struct{date=Wed Sep 11 02:00:00 CEST 2013,grade=A,score=6}, "
                  + "Struct{date=Thu Jan 24 01:00:00 CET 2013,grade=A,score=10}, "
                  + "Struct{date=Wed Nov 23 01:00:00 CET 2011,grade=A,score=9}, "
                  + "Struct{date=Thu Mar 10 01:00:00 CET 2011,grade=B,score=14}"
                + "],"
